...
export type Database = {
  ...
  public: {
    Tables: {
      categories: {
        Row: {
          class: Database["public"]["Enums"]["category_class_enum"]
          created_at: string
      ...
      records: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_ownership_constraint"
          ...
          {
            foreignKeyName: "records_record_sub_type_id_fkey"
    ...
    Enums: {
      category_class_enum: "must" | "want" | "need"
    }
    CompositeTypes: {
      [_ in never]: never
    }
